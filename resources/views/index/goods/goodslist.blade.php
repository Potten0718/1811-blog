...
<div class="maincont">
    ...
    <div class="prolist">
        @foreach($data as $v)
        <dl>
            <dt><a href="/index/goods/goodsinfo"><img src="{{config('app.img_url')}}{{$v->goods_logo}}" width="100" height="100" /></a></dt>
            <dd>
                <h3><a href="proinfo.html">{{$v->goods_name}}</a></h3>
                <div class="prolist-price"><strong>¥{{$v->goods_price}}</strong> <span>¥{{$v->goods_mprice}}</span></div>
                <div class="prolist-yishou"><span>5.0折</span> <em>已售：{{$v->goods_xiaoliang}}</em></div>
            </dd>
