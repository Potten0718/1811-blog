...
@section('content')
    ...
    <ul class="pronav">
        @foreach($brand as $v)
        <li><a href="/index/goods/goodslist/?brandd_id={{$v->brandd_id}}">{{$v->brandd_name}}</a></li>
        @endforeach
        <div class="clearfix"></div>
    </ul><!--pronav/-->
    <div class="index-pro1">
        ...
        <div class="index-pro1-list">
            <dl>
                <dt><a href="/index/goods/goodsinfo?goods_id={{$v->goods_id}}"><img src="{{config('app.img_url')}}{{$v->goods_logo}}" /></a></dt>
                <dd class="ip-text"><a href="proinfo.html">{{$v->goods_name}}</a><span>已售：{{$v->goods_xiaoliang}}</span></dd>
    ...
    <div class="prolist">
        @foreach($data as $v)
        <dl>
            <dt><a href="/index/goods/goodsinfo?goods_id={{$v->goods_id}}"><img src="{{config('app.img_url')}}{{$v->goods_logo}}" width="100" height="100" /></a></dt>
            <dd>
