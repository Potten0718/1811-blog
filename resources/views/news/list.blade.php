    ...
    <body>
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                <h3>商品列表</h3>
             <form action="">
                <input type="text" name="news_name" placeholder="请输入名称关键字" >
                <select name="ncate_id" id="">
                ...
                <tr id="tr2">
                    ...
                    <td>[<a href="javascript:void(0);" class="del" news_id="{{$v->news_id}}">删除</a>][<a href="/news/edit/{{$v->news_id}}">修改</a>][<a href="/news/xiangqing/{{$v->news_id}}">详情</a>]</td>
                </tr>
                @endforeach
                @endif
                </table>
