    ...
    <div id="pageAll">
        ...
        <div class="page">
            ...
            <div class="connoisseur">
                <div class="conform">
                    <form action="/user/add_do" method="post">
                        <div class="cfD">
                            {{csrf_field()}}
                            <input class="userinput" type="text" placeholder="输入用户名" id="user_name" name="user_name" />&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;
                            <input class="userinput vpr" type="text" placeholder="输入用户密码" id="user_pwd" name="user_pwd" />
